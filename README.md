...
**Automation & infra** — Ansible (roles, playbooks, multi-distro), Bash, Python, Docker & Docker Compose, CI/CD (GitHub Actions), Git.

**Systems** — Ubuntu/Debian/Fedora administration, SSH, PAM, SELinux/AppArmor, auditd, systemd, Proxmox virtualisation.

**Monitoring** — Prometheus, Grafana, ELK Stack, Node Exporter, Alertmanager, Lynis.
...
- Root-Me — Active challenges

---

## Contact

m.paquet.info@gmail.com · [LinkedIn](https://www.linkedin.com/in/mickael-paquet-7a0638312) · Based in Arlon, BE — Luxembourg cross-border
